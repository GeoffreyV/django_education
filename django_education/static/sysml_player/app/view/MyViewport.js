    ...
    var helpButtonPanel =  Ext.create('Ext.panel.Panel',
                                      {
                                          ...
                                          items:
                                              [
                                                  {
                                                      xtype: 'image',
                                                      src: 'images/LogoRenb.png',
                                                      width: imageWidth,
                                                      height: imageHeight,
                                                      title: window.resource.help_panel.retourText,
                                                      listeners:
                                                      {
                                                          render: function()
                                                          {
...
function createLogoPanel()
{
    ...
    var bannerImage = Ext.create('Ext.Img', {
        ...
        var DjangoEducationImage = Ext.create('Ext.Img', {
        autoRender: true,
        autoShow: true,
        src: window.resource.logo_panel.django_education.src,
        height: window.resource.logo_panel.django_education.height,
        width: window.resource.logo_panel.django_education.width,
        style:
        {
            paddingLeft: '10px',
            backgroundColor: 'transparent;'
